...
synth2.release.value = '2n';
synth2.resonance = 0.92;

let dSynth = new Tone.PolySynth();
let loPass = new Tone.Filter(800, "lowpass").toDestination();

dSynth.connect(loPass);
...
let pattern = new Tone.Pattern(function (time, note) {
  ...
  if (random(10) > 6) {
    synth2.triggerAttackRelease(patternNotes[Math.floor(random(5))], '4n', time + 0.25);
  }
}, ['C4', 'D4', 'E4', 'G4', 'A4']);
