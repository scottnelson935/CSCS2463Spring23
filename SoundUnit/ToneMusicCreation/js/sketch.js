...
const BbMinorScale = ['Bb', 'C', 'Db', 'Eb', 'F', 'Gb', 'Ab'];
...
function setup() {
  nxBut = new Nexus.Button('#nxButton');
  nxBut.on('change', () => {
